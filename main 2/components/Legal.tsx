...
export const PrivacyPolicy: React.FC<{ language: Language }> = ({ language }) => {
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-3 text-bharatStack-blue mb-6">
        <Shield size={32} />
...
export const TermsOfService: React.FC<{ language: Language }> = ({ language }) => {
  return (
    <div className="space-y-6">
       <div className="flex items-center gap-3 text-bharatStack-indigo mb-6">
        <FileText size={32} />
      ...
      <section>
        ...
        <p>By accessing Bharat Stack, you agree to be bound by these Terms of Service and all applicable laws and regulations.</p>
      </section>
