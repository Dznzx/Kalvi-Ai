            ...
            {navItems.map(item => (
                <button
                    ...
                    className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-200 font-medium ${
                        activeTab === item.id 
                        ? 'bg-bharatStack-blue text-white shadow-lg shadow-blue-200 dark:shadow-none' 
        ...
        <header className="bg-white dark:bg-[#111827] border-b border-gray-200 dark:border-white/5 h-16 flex items-center justify-between px-4 md:px-8 sticky top-20 z-20 transition-colors duration-300">
            ...
            <div className="flex items-center gap-4">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-bharatStack-terracotta to-orange-400 text-white flex items-center justify-center font-black text-xs shadow-lg shadow-orange-900/20 border-2 border-white/10">
