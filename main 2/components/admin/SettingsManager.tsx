...
export const SettingsManager: React.FC = () => {
  ...
  if (!settings) return (
      <div className="flex flex-col items-center justify-center h-96 space-y-4">
          <Loader2 className="animate-spin text-kalvi-terracotta" size={48} />
    ...
    <div className="max-w-4xl mx-auto space-y-8 animate-fade-in relative">
      ...
      <div className="sticky bottom-0 left-0 right-0 z-50 pt-10 pb-8 mt-12 bg-gradient-to-t from-gray-50 via-gray-50/90 dark:from-[#0B0F19] dark:via-[#0B0F19]/90 to-transparent backdrop-blur-sm flex justify-center md:justify-end">
          <button 
            onClick={handleSave}
            disabled={isSaving}
            className="bg-kalvi-terracotta text-white px-12 py-5 rounded-full font-black shadow-2xl shadow-orange-900/40 hover:bg-orange-600 active:scale-95 transition-all flex items-center gap-4 disabled:opacity-70 disabled:transform-none border-2 border-orange-400/30 group"
          >
            {isSaving ? (
