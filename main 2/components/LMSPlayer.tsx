      ...
      <div className="flex flex-col h-full bg-gray-50 fixed inset-0 z-50 overflow-hidden">
        <div className="bg-white border-b px-6 py-4 flex items-center justify-between sticky top-0 z-20 shadow-sm">
            <div className="flex items-center gap-4">
                ...
                <h2 className="text-xl font-bold text-bharatStack-indigo">{currentModule.title[language]}</h2>
            </div>
            <button 
        ...
        <div className="flex-1 overflow-y-auto p-4 sm:p-8 space-y-8 pb-24">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100">
                <div className="flex border-b border-gray-100">
                    <button onClick={() => setActiveTab('notes')} className={`flex-1 py-4 text-sm font-bold ${activeTab === 'notes' ? 'text-bharatStack-terracotta border-b-2 border-bharatStack-terracotta' : 'text-gray-500'}`}>Notes</button>
                    <button onClick={() => setActiveTab('transcript')} className={`flex-1 py-4 text-sm font-bold ${activeTab === 'transcript' ? 'text-bharatStack-terracotta border-b-2 border-bharatStack-terracotta' : 'text-gray-500'}`}>Transcript</button>
                    <button onClick={() => setActiveTab('quiz')} className={`flex-1 py-4 text-sm font-bold ${activeTab === 'quiz' ? 'text-bharatStack-terracotta border-b-2 border-bharatStack-terracotta' : 'text-gray-500'}`}>Assessment</button>
                </div>
                <div className="p-6">
                        ...
                        <div>
                            ...
                            {submissionStatus === 'submitted' ? <div className="text-green-600 font-bold">Successfully Submitted!</div> : (
                                <div className="space-y-4">
                                    ...
                                    <button onClick={handleAssessmentSubmit} disabled={!submissionText.trim()} className="bg-bharatStack-terracotta text-white px-8 py-3 rounded-xl font-bold">Submit</button>
                                </div>
                            )}
                        </div>
                    )}
