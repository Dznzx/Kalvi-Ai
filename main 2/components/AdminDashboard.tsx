    ...
    return (
        <div className="space-y-8 animate-fade-in pt-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                {[
                    { label: 'Total Schools', value: stats?.totalSchools || 0, icon: <MapPin className="text-bharatStack-terracotta" />, bg: 'bg-orange-50 dark:bg-orange-500/10' },
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="bg-white dark:bg-white/5 p-6 rounded-2xl border border-gray-100 dark:border-white/10 shadow-sm flex flex-col">
                    <div className="flex items-center gap-2 mb-6">
                        <AlertCircle size={20} className="text-bharatStack-terracotta" />
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="bg-white dark:bg-white/5 p-6 rounded-2xl border border-gray-100 dark:border-white/10 shadow-sm flex flex-col items-center">
                    ...
                    <div className="flex gap-6 mt-4">
                        <div className="flex items-center gap-2">
                            <Smartphone size={16} className="text-bharatStack-terracotta" />
                            <span className="text-xs font-bold text-gray-600 dark:text-gray-300">91% Mobile</span>
                        </div>
                        <div className="flex items-center gap-2">
                            <Laptop size={16} className="text-bharatStack-coffee" />
                ...
                <div className="lg:col-span-2 bg-white dark:bg-white/5 p-6 rounded-2xl border border-gray-100 dark:border-white/10 shadow-sm">
                    <div className="flex items-center justify-between mb-6">
                        ...
                        <button 
                            onClick={() => setActiveTab('schools')}
                            className="text-xs font-bold text-bharatStack-terracotta hover:underline"
                        >
                            View All Data
                        </button>
                    </div>
                    <div className="space-y-4">
                        {topSchools.map((school, i) => (
                            <div key={school.id} className="flex items-center justify-between p-4 bg-gray-50 dark:bg-white/5 rounded-xl border border-gray-100 dark:border-white/5 hover:border-bharatStack-terracotta/20 transition-all">
                                <div className="flex items-center gap-4">
                                    <div className="w-10 h-10 rounded-full bg-bharatStack-terracotta text-white flex items-center justify-center font-black">
                                        {i + 1}
                                    </div>
                                    <div>
                                ...
                                <div className="text-right">
                                    <p className="font-black text-bharatStack-terracotta text-lg">{school.hoursWatched.toLocaleString()}</p>
