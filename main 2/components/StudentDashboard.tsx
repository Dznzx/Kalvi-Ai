...
const StudentDashboard: React.FC<StudentDashboardProps> = ({ 
  ...
  const [activeTab, setActiveTab] = useState<'dashboard' | 'courses' | 'quizzes' | 'certificates' | 'settings'>('dashboard');
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-[#0B0F19] transition-colors duration-300 pt-20">
      ...
      <div className="md:hidden px-4 py-3 bg-white dark:bg-[#111827] border-b border-gray-200 dark:border-white/5 flex items-center justify-between sticky top-20 z-30">
          <div className="flex items-center gap-2">
              ...
              {isSyncing && <Cloud size={14} className="text-bharatStack-blue animate-pulse" />}
          </div>
                  ...
                  {menuItems.map(item => (
                      <button
                          ...
                          className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl font-bold text-sm transition-all ${
                              activeTab === item.id 
                              ? 'bg-bharatStack-terracotta text-white shadow-lg' 
                              : 'text-gray-600 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-white/5 hover:text-bharatStack-terracotta'
                          }`}
                      >
                          ...
                          <div className="flex-1 space-y-3">
                              <div className="flex justify-between items-end">
                                  <div className="flex items-center gap-3">
                                      ...
                                      {isSyncing && <Loader2 size={16} className="text-bharatStack-blue animate-spin mt-1" />}
                                  </div>
                  ...
                  <div className="bg-white dark:bg-[#1A1F2E] rounded-[2.5rem] border border-gray-100 dark:border-white/5 p-10 shadow-sm space-y-12">
                          ...
                          <div className="md:col-span-2">
                              <div className="grid grid-cols-2 gap-4">
                                  <button 
                                      ...
                                      className={`p-4 rounded-2xl border-2 flex flex-col items-center gap-2 transition-all ${settingsForm.gradeGroup === '6-8' ? 'border-bharatStack-terracotta bg-orange-50 dark:bg-orange-500/10 text-bharatStack-terracotta' : 'border-gray-100 dark:border-white/5 bg-gray-50 dark:bg-white/5 text-gray-400'}`}
                                  >
                                      <Rocket size={24} className={settingsForm.gradeGroup === '6-8' ? 'text-bharatStack-terracotta' : 'text-gray-400'} />
                                      <span className="font-black text-sm uppercase">Class 6 - 8</span>
                                  </button>
                                  <button 
                                      onClick={() => setSettingsForm({...settingsForm, gradeGroup: '9-12'})}
                                      className={`p-4 rounded-2xl border-2 flex flex-col items-center gap-2 transition-all ${settingsForm.gradeGroup === '9-12' ? 'border-bharatStack-terracotta bg-orange-50 dark:bg-orange-500/10 text-bharatStack-terracotta' : 'border-gray-100 dark:border-white/5 bg-gray-50 dark:bg-white/5 text-gray-400'}`}
                                  >
                                      <GraduationCap size={24} className={settingsForm.gradeGroup === '9-12' ? 'text-bharatStack-terracotta' : 'text-gray-400'} />
                      ...
                      <div className="flex justify-end pt-4">
                          <button 
                              ...
                              className="bg-bharatStack-terracotta text-white px-12 py-4 rounded-2xl font-black text-base shadow-xl hover:bg-orange-700 transition-all flex items-center gap-3 active:scale-95"
                          >
