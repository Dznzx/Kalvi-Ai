  ...
  const team = [
    {
      ...
      img: "https://ui-avatars.com/api/?name=Daksh&background=EA580C&color=fff&size=400&bold=true",
      scale: "scale-100",
      pos: "object-top"
    },
    {
      ...
      img: "https://ui-avatars.com/api/?name=Dinesh&background=4338CA&color=fff&size=400&bold=true",
      scale: "scale-100",
      pos: "object-top"
    },
    {
      ...
      img: "https://ui-avatars.com/api/?name=Tanvi&background=C2410C&color=fff&size=400&bold=true",
      scale: "scale-100",
      pos: "object-top"
    },
    {
      ...
      img: "https://ui-avatars.com/api/?name=Priyal&background=F59E0B&color=fff&size=400&bold=true",
      scale: "scale-100",
      pos: "object-top"
    }
  ];
    ...
    <div className="bg-white dark:bg-[#0B0F19] font-sans animate-fade-in transition-colors duration-300 w-full overflow-x-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="relative z-10 text-center md:text-left">
            ...
            <p className="text-lg md:text-xl text-slate-600 dark:text-gray-400 leading-relaxed mb-8 max-w-lg mx-auto md:mx-0">
              Bharat Stack is a Tamil Nadu based education platform built on a simple belief: 
      ...
      <section className="py-20 md:py-24 relative overflow-hidden text-white" style={{ background: 'linear-gradient(135deg, #1e1b4b 0%, #4338ca 100%)' }}>
          ...
          <div className="relative z-10 max-w-3xl mx-auto px-6 text-center">
              <BharatStackLogo className="h-10 md:h-12 mx-auto mb-8" color="white" showText={false} />
              
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-heading font-bold mb-8 leading-tight">
                  Bharat Stack is more than a platform.<br />
