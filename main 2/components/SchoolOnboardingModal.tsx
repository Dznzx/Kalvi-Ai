...
const SchoolOnboardingModal: React.FC<SchoolOnboardingModalProps> = ({ language, onClose, onSubmit }) => {
  ...
  const inputClass = "w-full pl-11 pr-4 py-3.5 bg-gray-50 dark:bg-black/20 border border-gray-200 dark:border-white/10 rounded-xl focus:bg-white dark:focus:bg-black/40 focus:border-bharatStack-terracotta focus:ring-4 focus:ring-orange-500/10 transition duration-200 outline-none text-gray-800 dark:text-white placeholder-gray-400 font-medium";
      ...
      <div className="bg-white dark:bg-[#0B0F19] rounded-3xl w-full max-w-2xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh]">
        ...
        <form onSubmit={handleFinalSubmit} className="flex-1 overflow-y-auto p-8 space-y-6">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="space-y-1.5">
                ...
                <div className="relative group">
                    <Building className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 group-focus-within:text-bharatStack-terracotta transition-colors" size={18} />
                    <input 
                        type="text" 
                        name="name"
                        value={formData.name}
            ...
            <div className="space-y-1.5">
                ...
                <div className="relative group">
                    <Hash className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 group-focus-within:text-bharatStack-terracotta transition-colors" size={18} />
                    <select 
                        name="board"
            ...
            <div className="space-y-1.5">
                ...
                <div className="relative group">
                    <User className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 group-focus-within:text-bharatStack-terracotta transition-colors" size={18} />
                    <input 
                        type="text" 
                        name="principalName"
            ...
            <div className="space-y-1.5">
                ...
                <div className="relative group">
                    <Mail className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 group-focus-within:text-bharatStack-terracotta transition-colors" size={18} />
                    <input 
                        type="email" 
                        name="email"
            ...
            <div className="space-y-1.5">
                ...
                <div className="relative group">
                    <Phone className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 group-focus-within:text-bharatStack-terracotta transition-colors" size={18} />
                    <input 
                        type="tel" 
                        name="phone"
                        maxLength={10}
            ...
            <div className="space-y-1.5">
                ...
                <div className="relative group">
                    <Users className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 group-focus-within:text-bharatStack-terracotta transition-colors" size={18} />
                    <input 
                        type="number" 
                        name="studentCount"
          ...
          <div className="bg-orange-50 dark:bg-orange-500/10 p-5 rounded-2xl border border-orange-100 dark:border-orange-500/20 flex gap-4">
              <div className="w-10 h-10 bg-white dark:bg-white/10 rounded-full flex items-center justify-center text-bharatStack-terracotta shadow-sm flex-shrink-0">
                  <CheckCircle size={20} />
              </div>
        ...
        <div className="p-6 border-t dark:border-white/5 bg-gray-50/50 dark:bg-black/20 flex justify-end">
            <button 
                ...
                className="w-full sm:w-auto px-10 py-4 bg-bharatStack-terracotta text-white rounded-xl font-black text-base shadow-xl shadow-orange-900/20 hover:bg-orange-600 transition-all active:scale-95 flex items-center justify-center gap-3 disabled:opacity-50"
            >
                {isSubmitting ? (
