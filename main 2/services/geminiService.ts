    ...
    const chat = client.chats.create({ 
      ...
      config: {
        systemInstruction: isTamil 
          ? "நீங்கள் Bharat Stack-ன் உதவியாளர். மாணவர்களுக்குக் கனிவாகவும் தெளிவாகவும் தமிழில் பதிலளிக்கவும்."
          : "You are the Bharat Stack assistant. Help students with their queries in a friendly and professional manner."
      }
    });
