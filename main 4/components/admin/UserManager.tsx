    ...
    <div className="space-y-6 animate-fade-in relative min-h-[600px]">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <button 
                ...
                className="bg-kalvi-terracotta text-white px-6 py-2.5 rounded-xl font-bold flex items-center gap-2 hover:bg-kalvi-terracottaDark shadow-lg shadow-orange-900/20 transition active:scale-95"
            >
        ...
        <div className="bg-white dark:bg-[#111827] p-4 rounded-xl border border-gray-100 dark:border-white/5 shadow-sm flex flex-col md:flex-row gap-4 justify-between items-center">
            <div className="relative flex-1 w-full max-w-md">
                ...
                <input 
                    ...
                    className="w-full pl-10 pr-4 py-2 border dark:border-white/10 rounded-xl focus:ring-2 focus:ring-kalvi-terracotta/20 outline-none transition bg-white dark:bg-black/20 text-gray-800 dark:text-white" 
                    ...
                    <form onSubmit={handleSubmit} className="p-6 space-y-5">
                        <div className="space-y-1.5">
                            ...
                            <input 
                                ...
                                className="w-full bg-gray-50 dark:bg-black/20 border border-gray-200 dark:border-white/10 rounded-xl px-4 py-3 text-gray-900 dark:text-white focus:ring-2 focus:ring-kalvi-terracotta/20 focus:border-kalvi-terracotta outline-none transition"
                        ...
                        <div className="space-y-1.5">
                            ...
                            <input 
                                ...
                                className="w-full bg-gray-50 dark:bg-black/20 border border-gray-200 dark:border-white/10 rounded-xl px-4 py-3 text-gray-900 dark:text-white focus:ring-2 focus:ring-kalvi-terracotta/20 focus:border-kalvi-terracotta outline-none transition font-mono"
                        ...
                        <div className="space-y-1.5">
                            ...
                            <div className="relative">
                                <select 
                                    ...
                                    className="w-full bg-gray-50 dark:bg-black/20 border border-gray-200 dark:border-white/10 rounded-xl px-4 py-3 text-gray-900 dark:text-white focus:ring-2 focus:ring-kalvi-terracotta/20 focus:border-kalvi-terracotta outline-none transition appearance-none cursor-pointer"
                                >
                        ...
                        <div className="pt-4 flex gap-3">
                            ...
                            <button 
                                type="submit" 
                                disabled={isLoading}
                                className="flex-1 py-3 bg-kalvi-terracotta text-white font-bold rounded-xl shadow-lg hover:bg-kalvi-terracottaDark transition flex items-center justify-center gap-2 disabled:opacity-70"
                            >
