    ...
    <div className="space-y-6 animate-fade-in relative min-h-[600px]">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        ...
        <button 
            ...
            className="bg-kalvi-terracotta text-white px-6 py-2.5 rounded-xl font-bold flex items-center gap-2 hover:bg-kalvi-terracottaDark shadow-xl shadow-orange-900/10 transition active:scale-95"
        >
      ...
      <div className="bg-white dark:bg-[#111827] p-4 rounded-xl border dark:border-white/5 shadow-sm flex flex-col md:flex-row gap-4 justify-between items-center transition-colors">
         <div className="relative flex-1 w-full max-w-md">
            ...
            <input 
                ...
                className="w-full pl-10 pr-4 py-2 border dark:border-white/10 rounded-xl focus:ring-2 focus:ring-kalvi-terracotta/20 outline-none transition bg-white dark:bg-black/20 text-gray-800 dark:text-white placeholder-gray-400" 
                placeholder="Search modules..." 
            />
         </div>
         <div className="flex gap-2 w-full md:w-auto items-center">
            <button onClick={fetchVideos} className="p-2 text-gray-400 hover:text-kalvi-terracotta rounded-lg hover:bg-gray-100 dark:hover:bg-white/5 transition">
                <RefreshCw size={20} />
            </button>
              ...
              { id: '9-12', label: '9-12' },
               ...
               <button 
                  ...
                  className={`px-4 py-2 border rounded-xl whitespace-nowrap text-xs font-bold transition-all ${
                    filter === f.id 
                    ? 'bg-kalvi-terracotta text-white border-kalvi-terracotta' 
      ...
      {isLoading ? (
          ...
          <div className="flex flex-col items-center justify-center py-24 text-center bg-white dark:bg-white/5 rounded-3xl border-2 border-dashed border-gray-200 dark:border-white/10">
              <div className="w-20 h-20 bg-orange-50 dark:bg-orange-500/10 rounded-full flex items-center justify-center mb-6">
                  <Video size={40} className="text-kalvi-terracotta" />
              </div>
                        ...
                        <tr key={video.id} className="hover:bg-gray-50/50 dark:hover:bg-white/5 transition group">
                            ...
                            <td className="px-6 py-4">
                                <div>
                                    ...
                                    <p className="text-[10px] text-kalvi-terracotta font-bold font-noto mt-0.5">{video.titleTa}</p>
                                </div>
                            </td>
                            ...
                            <td className="px-6 py-4 text-right">
                                <div className="flex justify-end gap-2">
                                    ...
                                    <button 
                                        ...
                                        className="p-2 text-gray-400 hover:text-kalvi-terracotta hover:bg-orange-50 dark:hover:bg-orange-500/10 rounded-lg transition"
                                        title="Edit Metadata"
                                    >
                                        <Edit size={18} />
                                    </button>
