  ...
  return (
    <div className="space-y-8 animate-fade-in relative">
      ...
      <div className="flex justify-between items-end">
          ...
          <button 
            onClick={loadData}
            className={`p-2.5 rounded-xl border border-gray-200 dark:border-white/10 text-gray-500 hover:text-kalvi-terracotta transition ${isRefreshing ? 'animate-spin' : ''}`}
            title="Refresh Data"
          >
              <RefreshCw size={18} />
          </button>
      ...
      <div className="bg-white dark:bg-[#111827] p-4 rounded-2xl border dark:border-gray-700 shadow-sm flex flex-col lg:flex-row gap-4 transition-colors">
          <div className="relative flex-1">
             ...
             <input 
                ...
                className="w-full pl-12 pr-4 py-2.5 bg-gray-50 dark:bg-[#1A1F2E] border-none rounded-xl focus:ring-2 focus:ring-kalvi-terracotta/20 outline-none font-medium text-gray-700 dark:text-white dark:placeholder-gray-500" 
          ...
          <div className="flex gap-4">
              <div className="relative min-w-[160px]">
                 ...
                 <select 
                    ...
                    className="w-full pl-10 pr-4 py-2.5 bg-gray-50 dark:bg-[#1A1F2E] border-none rounded-xl focus:ring-2 focus:ring-kalvi-terracotta/20 outline-none font-bold text-gray-600 dark:text-gray-300 appearance-none text-sm cursor-pointer"
                 >
              ...
              <div className="relative min-w-[160px]">
                 <select 
                    ...
                    className="w-full px-4 py-2.5 bg-gray-50 dark:bg-[#1A1F2E] border-none rounded-xl focus:ring-2 focus:ring-kalvi-terracotta/20 outline-none font-bold text-gray-600 dark:text-gray-300 appearance-none text-sm cursor-pointer"
                 >
                            ...
                            <tr key={school.id} className="hover:bg-gray-50/50 dark:hover:bg-white/5 transition group">
                                <td className="px-6 py-5">
                                    <div className="flex items-center gap-4">
                                        <div className="w-12 h-12 bg-orange-50 dark:bg-orange-500/10 rounded-xl flex items-center justify-center text-kalvi-terracotta group-hover:scale-110 transition-transform">
                                            <School size={24} />
                                        </div>
                                        <div>
                                ...
                                <td className="px-6 py-5">
                                    ...
                                    <a 
                                        ...
                                        className="text-xs text-kalvi-terracotta font-bold flex items-center gap-1 hover:underline"
                      ...
                      <div className="space-y-5">
                          ...
                          <div className="space-y-1.5">
                              ...
                              <input 
                                  ...
                                  className="w-full bg-gray-50 dark:bg-[#1A1F2E] border border-gray-200 dark:border-gray-700 rounded-lg px-3 py-2.5 text-sm font-bold text-gray-800 dark:text-white focus:ring-2 focus:ring-kalvi-terracotta/20 outline-none"
                              />
                          </div>
                          ...
                          <div className="space-y-1.5">
                              ...
                              <div className="relative">
                                  ...
                                  <input 
                                      ...
                                      className="w-full bg-gray-50 dark:bg-[#1A1F2E] border border-gray-200 dark:border-gray-700 rounded-lg pl-9 pr-3 py-2.5 text-sm font-bold text-gray-800 dark:text-white focus:ring-2 focus:ring-kalvi-terracotta/20 outline-none"
                                  />
                              </div>
                          </div>
                  ...
                  <div className="px-8 py-5 bg-gray-50 dark:bg-[#1A1F2E]/50 border-t border-gray-100 dark:border-gray-700 flex justify-between items-center">
                      ...
                      <div className="flex gap-3">
                          ...
                          <button 
                              ...
                              className="px-6 py-2.5 rounded-xl text-sm font-bold bg-kalvi-terracotta text-white shadow-lg shadow-orange-900/20 hover:bg-orange-600 transition flex items-center gap-2"
                          >
