      ...
      <div className="bg-white rounded-2xl w-full max-w-4xl shadow-2xl overflow-hidden flex flex-col md:flex-row h-[660px] max-h-[95vh]">
        ...
        <div className={`hidden md:flex flex-col justify-between w-5/12 p-10 text-white relative transition-colors duration-500 ${isAdminMode ? 'bg-gray-900' : 'bg-slate-900'}`}>
          ...
          <div className="relative z-10">
             ...
             <h2 className="text-3xl font-heading font-bold mb-3">
                 {isAdminMode ? 'Admin Portal' : (mode === 'login' ? t.welcomeBack : 'Join Kalvi.AI')}
             </h2>
          ...
          <div className="relative z-10 flex items-center gap-2 opacity-50">
            ...
            <span className="font-bold tracking-widest text-sm uppercase">Kalvi.AI</span>
          </div>
        </div>
        ...
        <div className="flex-1 bg-white relative flex flex-col overflow-y-auto px-8 md:px-16 py-10 custom-scrollbar">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button type="submit" disabled={isLoading} className={`w-full py-4 rounded-xl text-white font-bold shadow-lg hover:-translate-y-0.5 transition-all flex items-center justify-center gap-2 disabled:opacity-70 ${isAdminMode ? 'bg-gray-900' : 'bg-kalvi-terracotta'}`}>
          ...
          <div className="mt-6 text-center space-y-4">
              <p className="text-sm text-gray-500">
                ...
                <button onClick={() => setMode(mode === 'login' ? 'register' : 'login')} className="font-bold hover:underline text-kalvi-terracotta ml-1">
