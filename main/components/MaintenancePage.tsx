  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-[#0B0F19] flex flex-col items-center justify-center p-6 transition-colors font-sans">
      <div className="max-w-lg w-full bg-white dark:bg-[#1A1F2E] rounded-3xl shadow-2xl overflow-hidden border border-gray-100 dark:border-white/5 animate-fade-in-up">
        ...
        {/* Header Graphic */}
        <div className="bg-kalvi-terracotta h-32 flex items-center justify-center relative overflow-hidden">
        ...
        <div className="p-10 text-center">
            <div className="mb-6 flex justify-center">
                <KalviLogo className="h-10" showText={true} />
            </div>
            ...
            <p className="text-gray-500 dark:text-gray-400 mb-8 leading-relaxed">
                We are currently upgrading the Kalvi.AI platform to bring you new features and better performance. Access is temporarily restricted.
            </p>

            <div className="flex items-center justify-center gap-2 text-sm font-bold text-kalvi-terracotta bg-orange-50 dark:bg-orange-500/10 py-3 px-4 rounded-xl mb-8 border border-orange-100 dark:border-orange-500/20">
                <Clock size={16} />
