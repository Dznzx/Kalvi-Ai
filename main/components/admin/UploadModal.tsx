                ...
                <div className="space-y-6">
                    <div className="flex flex-col items-center justify-center border-4 border-dashed border-gray-100 dark:border-white/10 rounded-3xl py-10 bg-gray-50/30 dark:bg-white/5 hover:bg-gray-50 dark:hover:bg-white/10 transition cursor-pointer relative group">
                        {uploadProgress > 0 && uploadProgress < 100 ? (
                            <div className="w-full max-w-xs text-center">
                                <Loader2 className="animate-spin mx-auto text-kalvi-terracotta mb-4" size={48} />
                                <p className="font-bold text-gray-800 dark:text-white mb-2">Uploading to Cloud... {uploadProgress}%</p>
                                <div className="h-2 bg-gray-100 dark:bg-white/10 rounded-full overflow-hidden">
                                    <div className="h-full bg-kalvi-terracotta transition-all duration-300" style={{width: `${uploadProgress}%`}} />
                                </div>
                            </div>
                        ) : (
                            <>
                                ...
                                <div className="w-20 h-20 bg-orange-50 dark:bg-orange-500/10 rounded-2xl flex items-center justify-center text-kalvi-terracotta mb-6 group-hover:scale-110 transition-transform">
                                    <Film size={40} />
                                </div>
                    ...
                    <div className="bg-gray-50 dark:bg-white/5 p-6 rounded-2xl border border-gray-100 dark:border-white/10">
                         ...
                         <div className="flex gap-2">
                            ...
                            />
                            <button onClick={handleManualUrlSubmit} className="bg-kalvi-terracotta text-white px-6 rounded-xl font-bold">Connect</button>
                         </div>
                    </div>
                ...
                <div className="space-y-8">
                    ...
                    <div className="flex items-center justify-between p-4 bg-orange-50 dark:bg-orange-500/5 rounded-2xl border border-orange-100 dark:border-orange-500/20">
                        <div className="flex items-center gap-3 overflow-hidden">
                            <div className="p-2 bg-white dark:bg-white/10 rounded-lg shadow-sm text-kalvi-terracotta flex-shrink-0">
                                <Film size={20} />
                            </div>
                        ...
                        <button 
                            ...
                            className="flex items-center gap-1.5 px-3 py-1.5 bg-kalvi-terracotta text-white rounded-lg text-[10px] font-black uppercase tracking-wider hover:bg-orange-600 transition shadow-sm"
                        >
                    ...
                    <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 bg-gray-50/50 dark:bg-white/5 p-4 rounded-2xl border border-gray-100 dark:border-white/10">
                        <div>
                           <p className="font-bold text-gray-800 dark:text-white flex items-center gap-2"><Sparkles className="text-kalvi-terracotta" size={16}/> Smart Translate</p>
                        ...
                        <button 
                            ...
                            className="bg-white dark:bg-white/10 text-kalvi-terracotta border border-kalvi-terracotta/20 px-4 py-2 rounded-xl text-sm font-bold shadow-sm"
                        >
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                        <div className="space-y-1.5">
                            ...
                            <input 
                                className="w-full bg-gray-50 dark:bg-white/5 border-none rounded-xl px-4 py-3 focus:ring-2 focus:ring-kalvi-terracotta/20 outline-none font-bold text-gray-800 dark:text-white" 
                        ...
                        <div className="space-y-1.5">
                            <label className="block text-xs font-black text-kalvi-terracotta uppercase tracking-widest">Tamil Title</label>
                            <input 
                                className="w-full bg-gray-50 dark:bg-white/5 border-none rounded-xl px-4 py-3 focus:ring-2 focus:ring-kalvi-terracotta/20 outline-none font-bold text-gray-800 dark:text-white font-noto" 
                            ...
                            <div className="relative">
                                ...
                                <div className="absolute right-2 top-2">
                                    {isThumbnailUploading ? (
                                        <Loader2 className="animate-spin text-kalvi-terracotta" size={20} />
                                    ) : (
                            ...
                            <div className="grid grid-cols-2 gap-2">
                                {(['6-8', '9-12'] as GradeGroup[]).map(g => (
                                    <button
                                        ...
                                        className={`py-2 rounded-xl border-2 font-black text-xs transition-all ${formData.gradeGroup === g ? 'bg-kalvi-terracotta text-white border-kalvi-terracotta' : 'bg-white dark:bg-white/5 text-gray-400 border-gray-100 dark:border-white/10'}`}
                                    >
                                        Class {g}
                                    </button>
                                ))}
            ...
            <div className="flex gap-4">
                ...
                {step === 2 && (
                    <button 
                        ...
                        className="bg-kalvi-terracotta text-white px-10 py-3 rounded-xl font-black text-base hover:bg-kalvi-terracottaDark shadow-xl shadow-orange-900/20 transition disabled:opacity-50"
                    >
